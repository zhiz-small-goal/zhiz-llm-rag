...
_env_llm_api_key = os.environ.get("LLM_API_KEY", "").strip()
_env_openai_api_key = os.environ.get("OPENAI_API_KEY", "").strip()
LLM_API_KEY = _env_llm_api_key or _env_openai_api_key or "EMPTY"  # 优先环境变量，未配置则回退
