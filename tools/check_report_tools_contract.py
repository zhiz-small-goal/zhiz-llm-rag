...
Target-Module: mhy_ai_rag_data.tools.check_report_tools_contract
SSOT: src/mhy_ai_rag_data/tools/check_report_tools_contract.py
...
def main() -> int:
    _ensure_src_on_path()
    runpy.run_module("mhy_ai_rag_data.tools.check_report_tools_contract", run_name="__main__")
    return 0
